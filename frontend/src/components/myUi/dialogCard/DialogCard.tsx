      ...
      >
        ...
        <DialogContainer className={`${styles.dialogContent}`}>
          <DialogContent
            ...
            className={`${styles.dialogContent} m-3 pointer-events-auto relative flex h-auto w-full flex-col border border-zinc-950/10 bg-white dark:border-zinc-50/10 dark:bg-zinc-900 sm:w-[500px]`}
          >
            ...
            />
            <div className={`${styles.containerBottom} p-6`}>
